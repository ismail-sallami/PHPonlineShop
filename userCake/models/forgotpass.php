...
if(!empty($_GET["confirm"]))
{
    ...
    else
    {
        ...
        $hooks = array(
            ...
            "subjectStrs" => array($rand_pass,"sallami.ismail@gmail.com")
        );
        ...
        {
            if(!$mail->sendMail("sallami.ismail@gmail.com","Your new password"))
            {
...
if(!empty($_POST))
{
    ...
    if(count($errors) == 0)
    {
        ...
        else
        {
            ...
            {
                if(!$mail->sendMail("sallami.ismail@gmail.com","Lost password request"))
                {
                    $errors[] = lang("MAIL_ERROR");
