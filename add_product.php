	...
	<section id="form"><!--form-->
        <div class="container"><?php
            if ($_POST){
                ...
                $product_pic = $product_code . '.' . pathinfo(basename( $_FILES["fileToUpload"]["name"]),PATHINFO_EXTENSION);

                $sql = "INSERT INTO products (product_cat,product_code,product_name,product_desc_en,product_desc_de,product_desc_es,product_img_name,price,product_qty,product_origin)
                        VALUES ('$product_cat','$product_code', '$product_name', '$product_desc_en' ,'$product_desc_de' ,'$product_desc_es', '$product_pic', '$product_price', '$product_qty','$product_origin')";
            ...
            <div class="col-sm-4 col-sm-offset-1">
                ...
                <div class="login-form"><!--login form-->
                    ...
                    <form name='login' action='<?php echo ($_SERVER['PHP_SELF']); ?>' method='post' enctype="multipart/form-data">
                        ...
                        <input type="text" name="product_qty" value="0"  />
                        <label>Product image</label>
                        <input type="file" name="fileToUpload" accept="image/*">
                        <label>German description</label>
                        <textarea rows="4" name="product_desc_de" placeholder="Deutsch description"></textarea>
                        <label>English description</label>
                        <textarea rows="4" name="product_desc_en" placeholder="English description"></textarea>
                        <label>Spanish description</label>                        <textarea rows="4" name="product_desc_es" placeholder="Spanich description"></textarea>
