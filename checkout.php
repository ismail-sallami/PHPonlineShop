...
if(isset($_POST['firstname']))
{
	...
	if(!ctype_digit($zip)){
		$errors[] = lang("ACCOUNT_ZIP_INVALID_CHARACTERS");
	}
	...
	if(count($errors) == 0)
	{
		...
		$sql = "INSERT INTO bills VALUES ('$timestamp','$date','$time','$firstname', '$lastname', '$email', '$phone', '$address1', '$address1', '$zip', '$city', '$country','123', 'new' )";
		...
		if(isset($_SESSION["products"])) //check session var
		{
			foreach ($_SESSION["products"] as $cart_itm) {
				...
				$product = $cart_itm["product_name"];
				$quantity = $cart_itm["product_qty"];
				$price = $cart_itm["product_price"];
				$total = $quantity * $price;
				$sql = "INSERT INTO bill_line VALUES ('','$timestamp','$code','$product','$quantity','$price', '$total' )";
...
//Forms posted
if(!isset($_POST['city']) && (!empty($_POST) ))
				...
				<div class="col-sm-4">
					<div class="signup-form"><!--sign up form-->
						...
						<form name='newUser' action='<?php echo ($_SERVER['PHP_SELF']); ?>' method='post'>
							...
							<input type='text' name='address2' placeholder="Addess 2"/>
							...
							<button type="submit" class="btn btn-default">Pay out</button>
						</form>
					</div><!--/sign up form-->
				</div>
			</div>
