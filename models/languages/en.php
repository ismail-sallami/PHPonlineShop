...
$lang = array_merge($lang,array(
	...
	"ACCOUNT_FIRST_NAME_INVALID_CHARACTERS"	=> "First name can only include alphabetic character",
	"ACCOUNT_LAST_NAME_INVALID_CHARACTERS"	=> "Last name can only include alphabetic character",
	"ACCOUNT_ZIP_INVALID_CHARACTERS"	=> "Zip code can only include digits",
	...
	"BILL_DELETIONS_SUCCESSFUL"		=> "You have successfully deleted %m1% bills",
